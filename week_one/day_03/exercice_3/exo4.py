...
pythoon_duration = time.time() - start_time
print(f"Python array sum: {python_array_sum}, duration: {pythoon_duration:.6f} seconds")
...
print(f"Numpy is {pythoon_duration / numpy_duration:.2f} times faster than Python for summing an array of size {list_size}.")